...
REM First run creates the venv and installs dependencies; later runs just start the app.
cd /d "%~dp0"
...
REM Install deps only if a core import is missing (fast no-op on later runs).
